...
def test_replica_delete(grpc_controller_client):  # NOQA
    ...
    r1 = grpc_controller_client.replica_create(address=f'file://{f1}')
    grpc_controller_client.replica_update(r1.address, mode='RW')
    r2 = grpc_controller_client.replica_create(address=f'file://{f2}')
    grpc_controller_client.replica_update(r2.address, mode='RW')
    r3 = grpc_controller_client.replica_create(address=f'file://{f3}')
...
def test_replica_change(grpc_controller_client):  # NOQA
    ...
    r1 = grpc_controller_client.replica_create(address=f'file://{f}')
    assert r1.mode == 'WO'
